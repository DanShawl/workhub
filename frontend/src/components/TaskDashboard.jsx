    ...
    <>
      <div className=" mt-14 md:mt-0 bg-[#edeeef] md:ml-[146px] h-screen flex flex-col text-sm md:w-fit">
        ...
        <section className=" md:ml-[200px]">
          <div className=" mx-6 mt-6 flex items-center justify-between gap-x-4">
            <div>
              <div className="flex items-center gap-x-2 text-gray-500 font-medium mb-2">
                <span className=" text-[#ff5c35] hover:underline hover:underline-offset-4 cursor-pointer decoration-[#ff5c35]">
                  Dashboard
                </span>{' '}
              ...
              <div className="">
                <h1 className="font-semibold text-3xl mb-0 pb-1 text-[#2e4753]">
                  Work Orders
                </h1>
          ...
          <div className="md:fixed top-0 left-[146px] md:border-r-[1px] md:border-gray-300 md:h-screen md:bg-[#edeeef]">
            <ul className=" overflow-x-scroll flex md:flex-col font-semibold md:font-normal">
              <li
                className={` ${
                  currentTaskStatus === 'All'
                    ? 'md:bg-[#faad8c3d] border-[#ff5c35] text-[#2e4753]'
              ...
              >
                All Work Orders{' '}
                <div className=" w-4 h-4 rounded-full flex items-center justify-center text-[#ff5c35] text-xs ml-1 font-semibold">
                  {tasks.length}
                </div>
              </li>
              <li
              ...
              >
                Open
                <div className=" w-4 h-4 rounded-full flex items-center justify-center text-xs ml-1 text-[#ff5c35] font-semibold">
              ...
              <li
                className={` ${
                  currentTaskStatus === 'Closed'
                    ? 'md:bg-[#faad8c3d] border-[#ff5c35] text-[#2e4753]'
                    : 'border-gray-300 sm:border-transparent md:border-transparent text-gray-500'
                } cursor-pointer md:border-r-4 md:border-b-0 border-b-2 hover:border-[#ff5c35]  px-6 min-w-fit py-3 md:w-[200px] flex items-center md:justify-between md:font-medium`}
        ...
        <section className="md:ml-[200px] bg-[#edeeef]">
