...
const ContactWorkOrderItem = ({ task, removeWorkOrder }) => {
  ...
  return (
    <li className="grid grid-cols-3 gap-y-4 sm:gap-y-0 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-5 w-full px-6 py-4 gap-x-6 border-t-[1px] sm:border-0 sm:border-b-[1px] border-gray-200 hover:cursor-pointer hover:bg-[#f2f2f2] font-sans text-xs">
